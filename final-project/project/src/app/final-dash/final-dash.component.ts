...
export class FinalDashComponent implements OnInit{
  ...
  constructor(private datePipe: DatePipe,private requestService: RequestService, private employeeService: EmployeeService, private router: Router, private dataService: DataService, private fb: FormBuilder) {
